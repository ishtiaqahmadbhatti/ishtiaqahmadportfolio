...
@Component({
      ...
      <div class="hero-grid container">
        <div class="hero-text">
          ...
          <div class="hero-actions">
            <a href="#contact" class="btn btn-primary" (click)="scrollToContact($event)">Let's Connect</a>
            <a href="#about" class="btn btn-secondary" (click)="scrollToAbout($event)">Discover More</a>
          </div>
        ...
        <div class="hero-image-wrapper">
          <div class="image-border-glow">
            ...
            <div class="profile-pic-container">
              ...
              <img src="ishtiaqprofile.png" alt="Ishtiaq Ahmad Styled Profile" class="profile-pic pic-overlay" />
            </div>
          </div>
        </div>
      </div>
  ...
  styles: [`
    .hero-section {
      ...
      background: radial-gradient(circle at center, rgba(16, 20, 29, 0.4) 0%, rgba(8, 11, 17, 1) 100%);
      padding-top: 120px;
      padding-bottom: 70px;
      position: relative;
      overflow: hidden;
...
export class HeroComponent implements OnInit, OnDestroy {
  protected readonly stats = signal<Stat[]>([
    ...
    { label: 'Graduation CGPA', count: 0.00, target: 3.45, suffix: '/4.0', isDecimal: true }
  ]);
