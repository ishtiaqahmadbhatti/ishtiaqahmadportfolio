    ...
    <section class="about-section section-padding">
      <div class="container">
        ...
        <div class="about-content">
          <div class="about-bio">
            <p>
              I am a Computer Science graduate with a high-standing CGPA of
              <strong>3.45/4.0</strong> from
              <strong>Arid Agriculture University Rawalpindi, Pakistan</strong>. From the outset of
              my academic journey, I have been deeply driven by the challenge of transforming
              complex theoretical concepts into robust, production-ready systems. Today, as a Full
              Stack Software, AI, Cloud & DevOps Engineer, I operate at the intersection of
              application development, cloud-native deployments, and advanced cognitive systems,
              crafting high-performance digital solutions that scale.
            </p>
            <p>
              With over 3+ years of professional remote engineering experience at
              <strong>URemit International Corporation (UAE)</strong>, I specialize in architecting
              reliable backend infrastructures using <strong>.NET Core (C#)</strong> and
              <strong>FastAPI (Python)</strong>, complemented by reactive, high-fidelity user
              interfaces built with <strong>Angular</strong>. My mobile and desktop development
              expertise covers building cross-platform apps using <strong>Flutter</strong>, hybrid
              solutions with <strong>Ionic and Capacitor</strong>, and legacy integration client
              software. To support these systems, I build automated CI/CD orchestration pipelines,
              manage containerized clusters using <strong>Docker</strong> and
              <strong>Kubernetes</strong>, and engineer secure, resilient cloud solutions on
              <strong>AWS</strong>.
            </p>
            <p>
              A major focus of my technical expansion is in artificial intelligence and deep
              learning. Through rigorous training and hands-on projects—including the
              <em>Data Science Mentorship Program</em> and <em>100 Days of Deep Learning</em>—I have
              mastered high-dimensional tensors, GPU-accelerated training, and custom neural
              architectures in <strong>PyTorch</strong>. I design state-of-the-loop Agentic AI
              workflows using <strong>LangChain</strong> and <strong>LangGraph</strong>, build local
              and remote <strong>Model Context Protocol (MCP)</strong> servers to interface LLMs
              with custom enterprise databases, and configure SQLite-backed state persistence
              alongside <strong>LangSmith</strong> telemetry for production observability.
            </p>
            <p>
              I believe in clean-code architectures, meticulous observability, and security-first
              engineering. Whether implementing a real-time transactional system, optimizing cloud
              infrastructure costs, or developing an agentic RAG solution to interact with
              structured and unstructured datasets, I approach every project with a devotion to
              performance and fine details. My goal is to continually push boundaries, innovate
              alongside emerging technological trends, and construct intelligent software that
              ...
              <ul>
                ...
                <li>
                  ...
                  <div>
                    ...
                    <a href="mailto:ishtiaq.ahmad.devpro@gmail.com" class="value"
                      >ishtiaq.ahmad.devpro&#64;gmail.com</a
                    >
                  </div>
                </li>
                <li>
                ...
                <li>
                  ...
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      class="value hover-link"
                      >linkedin.com/in/ishtiaqahmadbhatti/</a
                    >
                  </div>
                </li>
                <li>
                  ...
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      class="value hover-link"
                      >github.com/ishtiaqahmadbhatti</a
                    >
                  </div>
                </li>
                <li>
                  ...
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      class="value hover-link"
                      >gitlab.com/ishtiaqahmadbhatti</a
                    >
                  </div>
                </li>
              </ul>
  ...
  protected readonly timeline: TimelineItem[] = [
    {
      ...
      description:
        'Acquired core computing knowledge in programming, databases, data structures, and computer networks. Graduated with a high-standing CGPA of 3.45/4.0.',
      align: 'left',
    },
    {
      date: '2022 (3 Months)',
      ...
      description:
        'Worked with ASP.NET MVC, Entity Framework, jQuery, Bootstrap, Ajax, and MS SQL Server to deploy and coordinate automated user check-in dashboards.',
      align: 'right',
    },
    {
      date: '2022 - 2025',
    ...
    },
    {
      ...
      description:
        'Completed a comprehensive mentorship program focusing on Python fundamentals, OOP, SQL databases, descriptive/inferential statistics, linear algebra, and supervised/unsupervised machine learning models (Regression, KNN, SVM, Naive Bayes, PCA).',
      align: 'right',
    },
    {
      date: '2023 - 2024',
      ...
      description:
        'Completed a comprehensive 100-day course covering Artificial Neural Networks (ANN), Convolutional Neural Networks (CNN), Recurrent Neural Networks (RNN), LSTMs, GRUs, and Transformer architectures (Self-Attention, Multi-Head Attention, Encoder-Decoder Seq2Seq).',
      align: 'left',
    },
    {
      date: '2025',
