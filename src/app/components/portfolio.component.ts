  ...
  protected readonly projects: Project[] = [
    {
      ...
      description: 'A massive multi-platform file conversion suite featuring 245+ tools across 15+ categories. Engineered with a FastAPI/Python 3.14 backend, an Angular web dashboard, and a premium Flutter mobile client. Leverages PostgreSQL database configurations and Docker containers.',
      tags: ['FastAPI', 'Python', 'Angular', 'Flutter', 'PostgreSQL', 'Docker'],
      link: 'https://smartconverter.net/'
    },
    {
      title: 'Smart Downloader',
      description: 'A robust multi-platform media downloading and transcription service. Engineered with a FastAPI/Python backend utilizing yt-dlp, OpenAI Whisper AI for audio-to-text transcribing, and FFmpeg for media stream merging. Deployed serverless on AWS Lambda using Docker containers, integrated with Amazon S3, an Angular web dashboard, and a Flutter mobile app.',
      tags: ['FastAPI', 'Python', 'OpenAI Whisper', 'AWS Lambda', 'Angular', 'Flutter'],
      link: 'https://smartdownloader.techmindsforge.com'
    },
    {
      title: 'ChatWithData',
      description: 'An agentic RAG (Retrieval-Augmented Generation) platform enabling interactive Q&A over documents and YouTube video transcripts. Features a FastAPI/Python backend utilizing LangChain, LangGraph (with LangSmith observability), a local FAISS vector database, and FastMCP server protocol. Serves web queries via a responsive Angular client and mobile requests using a cross-platform Flutter application.',
      tags: ['FastAPI', 'LangChain', 'LangGraph', 'FAISS', 'Angular', 'Flutter'],
      link: 'https://chatwithdata.techmindsforge.com'
    },
    {
      title: 'Smart Reader',
      description: 'An advanced multi-format client-side document and ebook reader application. Engineered with custom ePUB parsing, PDF rendering (PDF.js), and dynamic document formatting (Mammoth.js for Word, SheetJS for Excel sheets, and Marked for Markdown). Uses browser IndexedDB for offline document storage, and includes detailed reading session analytics with customizable viewing configurations. Powered by an Angular web app and a Flutter mobile client.',
      tags: ['Angular', 'Flutter', 'ePub.js', 'IndexedDB', 'PDF.js', 'Mammoth.js']
    },
    {
      title: 'URemit API Services',
      description: 'Engineered high-performance backend Web APIs for financial transactions. Standardized routes and models, built logging configurations, and connected endpoints securely to MS SQL databases.',
      tags: ['C#', '.NET Core API', 'MS SQL Server', 'Swagger']
    },
    {
      title: 'URemit Web App',
      description: 'Developed custom screens and reactive interfaces matching customer criteria. Managed routing states, validated data structures, and resolved integration issues with backend REST APIs.',
      tags: ['Angular 14', 'TypeScript', 'HTML5/CSS3', 'RxJS']
    },
    {
      title: 'URemit Mobile App',
      description: 'Built cross-platform application screens using web technology. Designed dynamic list views, configured mobile push notices, and bundled build scripts using Android Studio.',
      tags: ['Ionic Framework', 'Capacitor', 'Angular', 'TypeScript']
    },
    {
      title: 'URemit Desktop App',
      description: 'Created desktop software integration modules supporting legacy devices. Integrated Windows Forms, automated update checks, and mapped API connections securely.',
      tags: ['C#', 'Windows Forms', 'REST API Client', 'XML']
    },
    {
      title: 'Attendance Management',
      description: 'Built during an internship. Automates employee logs, records clock-ins/outs, tracks leave approvals, and models dynamic dashboards. Used EF, jQuery, and MVC templates.',
      tags: ['ASP.NET MVC', 'Entity Framework', 'jQuery', 'Bootstrap']
    },
    {
      title: 'GROCERY PRO App (FYP)',
      description: 'Final Year Project. Direct Android application connecting local grocery systems to shoppers. Features search filters, item listings, cart storage, and mock-payment layouts.',
