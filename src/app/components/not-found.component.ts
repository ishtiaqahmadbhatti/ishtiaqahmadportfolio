    ...
    <div class="not-found-container">
      ...
      <div class="not-found-content">
        ...
        <p class="error-description">
          The page you are trying to access doesn't exist, has been moved, or is temporarily
          unavailable. Let's guide you back to safety.
        </p>
    ...
    `
      ...
      @keyframes pulse {
        ...
        50% {
          ...
          text-shadow: 0 0 60px rgba(0, 242, 254, 0.4);
        }
      }
