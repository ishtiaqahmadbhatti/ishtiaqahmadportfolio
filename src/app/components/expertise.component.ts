  ...
  protected readonly devOpsTabs: ExpertiseTab[] = [
    {
      ...
      icon: 'fab fa-aws',
      description:
        'My expertise in Amazon Web Services (AWS) is extensive, covering a wide array of services crucial for building scalable, secure, and highly available cloud infrastructure.',
      sections: [
        {
    ...
    },
    {
      ...
      icon: 'fas fa-cubes',
      description:
        'My expertise in Kubernetes encompasses a wide range of core concepts, advanced features, and practical applications, making me proficient in deploying, managing, and scaling containerized applications.',
      sections: [
        {
    ...
    },
    {
      ...
      description:
        'My expertise in Terraform focuses on leveraging Infrastructure as Code (IaC) principles to efficiently provision, manage, and scale cloud resources across various providers.',
      sections: [
        {
    ...
    },
    {
      ...
      icon: 'fab fa-docker',
      description:
        'My expertise in Docker enables me to containerize applications efficiently, ensuring consistent environments across development, testing, and production.',
      sections: [
        {
    ...
    },
    {
      ...
      icon: 'fab fa-jenkins',
      description:
        'My expertise in Jenkins is centered on building robust Continuous Integration and Continuous Delivery (CI/CD) pipelines, automating the software development lifecycle from code commit to deployment.',
      sections: [
        {
    ...
    },
    {
      ...
      description:
        'My expertise in Ansible focuses on automation for configuration management, application deployment, and orchestration, enabling efficient and scalable IT infrastructure management.',
      sections: [
        {
    ...
    },
    {
      ...
      icon: 'fab fa-gitlab',
      description:
        'My expertise in GitLab spans its comprehensive capabilities for the entire DevOps lifecycle, from source code management to advanced CI/CD and DevSecOps practices.',
      sections: [
        {
    ...
    },
    {
      ...
      description:
        'My expertise in Shell Scripting is fundamental for automating repetitive tasks, managing system configurations, and orchestrating complex workflows in Linux environments.',
      sections: [
        {
    ...
    },
    {
      ...
      description:
        'Building high-performance cross-platform and hybrid mobile applications using modern web and native technologies.',
      sections: [
        {
          title: 'Flutter & Dart',
          points: [
  ...
  protected readonly aiTabs: ExpertiseTab[] = [
    {
      ...
      icon: 'fas fa-robot',
      description:
        'Orchestrating robust stateful agent environments, multi-agent networks, transcript indexers, and local LLM pipelines.',
      sections: [
        {
    ...
    },
    {
      ...
      description:
        'Architecting and optimizing artificial neural networks, computer vision, sequence modeling, and transformer pipelines using PyTorch.',
      sections: [
        {
    ...
    },
    {
      ...
      description:
        'Building reliable regression, classification, and clustering models using robust feature engineering and validation pipelines.',
      sections: [
        {
    ...
    },
    {
      ...
      description:
        'Data extraction, pipeline cleaning, exploratory data analysis, and user-facing dashboard deployment.',
      sections: [
        {
    ...
    },
    {
      ...
      description:
        'Statistical modeling, probability distributions, hypothesis testing, and mathematical foundations.',
      sections: [
        {
    ...
    },
    {
      ...
      description:
        'Expertise in SQL relational design, NoSQL document modeling, and high-dimensional vector embeddings for AI systems.',
      sections: [
        {
